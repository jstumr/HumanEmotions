...
<title>Task 2 - Übungsdurchgänge 1</title>
...
<script langauge="text/javascript"> 
		...
		var flag = 0;
            ...
            function refreshDiv(){  
            	...
            	if(flag == 0)
            	{ 
            		document.getElementById('divImg').setAttribute('src', "images/practice_task/task2sample2.jpg");
            		flag = 1;
            	}
...
<body bgcolor="#C0C0C0">
<form action="task2practicetask3.jsp" method="post">
<%
	System.out.println("task2practicetask2.jsp : " + session.getAttribute("testType")
