...
<script langauge="text/javascript"> 
		...
		var flag = 0;
            ...
            function refreshDiv(){  
            	...
            	if(flag == 0)
            	{ 
            		document.getElementById('divImg').setAttribute('src', "images/practice_task/practice2.jpg");
            		flag = 1;
            	}
...
<body bgcolor="#C0C0C0">
<form action="practicetask3.jsp" method="post">
<%
	System.out.println("practicetask2.jsp : " + session.getAttribute("testType")
